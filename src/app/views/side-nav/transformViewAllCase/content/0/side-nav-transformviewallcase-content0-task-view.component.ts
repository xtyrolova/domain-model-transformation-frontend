...
@Component({
    selector: 'app-side-nav-transformviewallcase-content0-task-view',
    templateUrl: './side-nav-transformviewallcase-content0-task-view.component.html',
    styleUrls: ['./side-nav-transformviewallcase-content0-task-view.component.scss'],
    providers: [
        CategoryFactory,
        TaskViewService,
        SearchService,
...
export class SideNavTransformviewallcaseContent0TaskViewComponent extends AbstractTabbedTaskViewComponent implements AfterViewInit {
