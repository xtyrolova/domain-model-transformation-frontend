...
@Component({
    selector: 'app-side-nav-associationmanagerview-content0-task-view',
    templateUrl: './side-nav-associationmanagerview-content0-task-view.component.html',
    styleUrls: ['./side-nav-associationmanagerview-content0-task-view.component.scss'],
    providers: [
        CategoryFactory,
        TaskViewService,
        SearchService,
...
export class SideNavAssociationmanagerviewContent0TaskViewComponent extends AbstractTabbedTaskViewComponent implements AfterViewInit {
